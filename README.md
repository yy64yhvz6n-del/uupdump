...
- **`remove_edge`**: Removes Microsoft Edge (Only Tiny11). **Not Recommended**, as it can cause issues with some apps. If you do not include it, you can install a browser using Winget.
